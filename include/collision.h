...
/*
* @brief test to see if a line generated by two points will colide with the world
* @param tile_count: the number of tiles to check collisions for
* @param physics_layer: the tiles for collision testing
* @param a: the first point in the line (assumed to be on the left)
* @param b: the second point in the line (assumed to be on the right)
* @return 1if collision, 0 otherwise
*/
